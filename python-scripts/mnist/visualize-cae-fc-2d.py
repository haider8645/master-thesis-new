...
model_def = '/home/lod/master-thesis/examples/master-thesis/new_models/caeWithoutFClayer/building_model/adam-conv4-good-results/snapshots/snapshots-fused-28-05-2018-good-results-bn-used/good-4-conv4/train-4-conv4-smaller.prototxt'
...
model_weights = '/home/lod/master-thesis/examples/master-thesis/new_models/caeWithoutFClayer/building_model/adam-conv4-good-results/snapshots/snapshots-fused-28-05-2018-good-results-bn-used/good-4-conv4/_iter_300000.caffemodel'
...
cbar.ax.set_yticklabels(['Cardboard', 'Pamphlets', 'Empty', 'Plastic Foil', 'Shredded Paper','glass'])  # vertically oriented colorbar

plt.title('Fused Network with BN')
#plt.suptitle('2048 dimensions mapped in 2D space using t-SN)
plt.xlabel('Dimension-1')
plt.ylabel('Dimension-2')
plt.savefig('30-06-2018-completeley-trained.png')
