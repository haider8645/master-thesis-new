...
model_def = '/home/haider/Desktop/biba-trained-models/cae--04/train-mnistcae04.prototxt'
model_weights = '/home/haider/Desktop/biba-trained-models/cae--04/snapshots_iter_cae04_50000.caffemodel'
...
a = np.arange(20000).reshape(5000, 4)
...
Y = tsne.tsne(a, no_dims= 2, initial_dims=4, perplexity=30.0)
