...
model_def = '/home/lod/master-thesis/examples/master-thesis/new_models/caeWithFClayer/FC-layer-2040-Maxpool/train-poolinglayer.prototxt'
model_weights = '/home/lod/master-thesis/examples/master-thesis/new_models/caeWithFClayer/FC-layer-2040-Maxpool/snapshots/_iter_100000.caffemodel'
...
#a = np.arange(5000).reshape(10, 500)
#print a.shape
...
#Y = tsne.tsne(a, no_dims= 2, initial_dims=500, perplexity = 30.0)
#fig = plt.figure()
